...
// Don't use getAnalytics — not supported in React Native

// Add additional imports here (e.g., getAuth, getFirestore) if needed

const firebaseConfig = {
  apiKey: "AIzaSyDjQVfHQwZKzceTRk77JBPh8Pmodo-YiS8",
  authDomain: "clubhub-c85fd.firebaseapp.com",
  projectId: "clubhub-c85fd",
  storageBucket: "clubhub-c85fd.appspot.com", // slight correction
